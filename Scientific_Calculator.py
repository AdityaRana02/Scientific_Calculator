...
print("Type 'mod' for Modulus Operator")
...
while True:
    ...
    if choice=='a':
        ...
        if numerator<denominator:
            print("Error, Numerator must be greater than denominator.")
        else:
            print("Modulus of Entered Numbers is: ", numerator%denominator)
    elif choice=='sq':
        ...
        print("\nInvalid Input! \nMake sure you typed the correct choice.")
print("Thank You")